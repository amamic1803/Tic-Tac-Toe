...
root.iconbitmap(resource_path("tic-tac-toe.ico"))
root.configure(background="#ffffff")

# using images for o because tkinter's circle is not anti-aliased (not pretty)
photo_o = PhotoImage(file=resource_path("o-image.png"))
photo_o_small = PhotoImage(file=resource_path("o-image-small.png"))
...
best_moves = {}
with open(resource_path("pve-moves.txt"), "r") as file:
	run = True
	while run:
